    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-dietplan">
                        <a href="diet-plan.php" class="non-style-link-menu">
                            <div>
                                <img src="../img/1048341-200.png" alt="Diet Plan Icon" class="icon" style="width: 32px; height: 32px; vertical-align: middle; margin-left: 80px; margin-bottom:-60px ">
                                <p class="menu-text">Diet Plan</p>
                            </div>
                        </a>
                    </td>
                </tr>
